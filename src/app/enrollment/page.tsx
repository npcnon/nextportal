...
export default function EnrollmentForm() {
  ...
  useEffect(() => {
    const fetchPrograms = async () => {
      try {
        const response = await axios.get(`https://dangoportal.onrender.com/api/program/?campus_id=${formData.campus}`)
...
try{
  ...
  try {
    ...
    const response = await axios.post('https://dangoportal.onrender.com/api/stdntbasicinfo/', formData)
