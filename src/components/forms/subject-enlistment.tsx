...
export const SubjectEnlistment = () => {
  ...
  const fetchEnrolledSubjects = async () => {
    ...
    try {
      const response = await axios.get(`https://afknon.pythonanywhere.com/api/student-enlist/?filter=fulldata_applicant_id=${studentId}`);
  ...
  const fetchSubjects = async () => {
    try {
      const response = await axios.get('https://afknon.pythonanywhere.com/api/class-list/');
  ...
  const handleEnlistment = async (subjectId: number) => {
    ...
    try {
      await axios.post('https://afknon.pythonanywhere.com/api/student-enlist/', {
