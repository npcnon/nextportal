...
const DocumentUploadManager = () => {
  ...
  const handleFileUpload = async (file: File, documentType: string) => {
    ...
    return new Promise((resolve, reject) => {
      ...
      xhr.open('POST', 'https://djangoportal-backends.onrender.com/api/upload/');
  ...
  const fetchRefreshToken = async (refreshToken: string | null) => {
    const response = await fetch('https://djangoportal-backends.onrender.com/api/refresh-token', {
      method: 'POST',
      headers: {
